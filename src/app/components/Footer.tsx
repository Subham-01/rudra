      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid gap-10 md:grid-cols-4">
          <div className="space-y-4">
            <Link href="/" className="inline-flex h-32 w-[15rem] items-start overflow-hidden sm:h-36 sm:w-[17rem]">
              <Image
                src="/images/Logo-removebg-preview.png"
                alt="Hotel Rudra Regency"
                width={512}
                height={512}
                className="-ml-8 -mt-10 h-52 w-auto max-w-none object-contain sm:-ml-10 sm:-mt-12 sm:h-60"
              />
            </Link>
          ...
          <div>
            <p className="mb-4 text-lg font-semibold text-amber-100">Support</p>
            <ul className="space-y-3 text-neutral-400">
          ...
          <div>
            ...
            <div className="space-y-3 text-neutral-400">
              <p>Chandrahiya, Motihari, Chararhiya, Bihar 845401</p>
              <p>info@rudraregency.com</p>
              <p>+91 8651600015 | +91 8581828182</p>
            </div>
          </div>
        </div>

        <div className="mt-12 border-t border-amber-400/10 pt-6 text-center text-sm text-neutral-500">
