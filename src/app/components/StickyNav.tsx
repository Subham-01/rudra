...
export default function StickyNav({ settings = {} }: { settings?: Record<string, string> }) {
  const pathname = usePathname();
  const [mobileOpen, setMobileOpen] = useState(false);
  const bookingHref = createHotelInquiryLink("a stay at Hotel Rudra Regency in Motihari", [], settings.whatsapp_number);
